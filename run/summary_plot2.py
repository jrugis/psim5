...
for cell in range(ncells):
  ...
  plots[0, cell].plot(x, ca_apical, color='blue', label='apical')
  plots[0, cell].plot(x, ca_basal, color='red', label='basal')
  plots[0, cell].legend(loc='best')
  plots[1, cell].plot(x, ip_apical, color='blue', label='apical')
  plots[1, cell].plot(x, ip_basal, color='red', label='basal')
  plots[1, cell].legend(loc='best')
  plots[2, cell].plot(x, volumes[:, cell], color='blue')
